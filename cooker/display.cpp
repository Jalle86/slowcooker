...
static struct lcd_state option_next(void);
...
static struct lcd_state states[] =
{
...
{
    { "Target", "Target temp.:", states[2] },
    { "Timer", "Timer:", states[3] },
    { "Back", NULL, states[0] },
};
